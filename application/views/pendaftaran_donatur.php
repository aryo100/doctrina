...
<html>
  ...
  <body>
    <div class="container">  
      <h2>Form Pendaftaran Donatur</h2>
      <!-- <form method="post" action="<?php echo base_url();?>/Daftar/dona_simpan"> -->
      <?php echo form_open_multipart('Daftar/dona_simpan');?>
        <div class="row">
          <h4>Data Akun</h4>
        ...
        <div class="row">
            <div class="input-group pekerja">
              <h4>Upload Surat Pekerja Aktif</h4>
              <div class="col-third">
                <div class="image_preview pekerja">
                  <img class="pict_url" src="">
                </div>
              </div>
              <div class="col-ninth">
                <input name="ss_aktif" class="upload_btn_pekerja_aktif" data-target=".pekerja" type="file" accept="image/*" style="float: left;" required/>
              </div>
        </div>
        <div class="row">
            <div class="input-group slip_gaji">
              <h4>Upload Bukti Slip Gaji</h4>
              <div class="col-third">
              ...
              <div class="col-ninth">
                <input name="ss_gaji" class="upload_btn_slip_gaji" data-target=".gaji" type="file" accept="image/*" style="float: left;">
              </div>
        </div>
        <div class="row">
          <div class="input-group">
