								...
								<td>
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-left" role="menu">
											<li>
												<a href="<?php echo base_url();?>index.php/<?php echo $this->session->userdata('role');?>/data_lengkap/<?php echo $obj1->id.'/';?><?php if($this->session->userdata('role')=='donatur'){echo 'penerima';}else{echo 'donatur';}?>">
													<i class="icon-user"></i> See More </a>
											</li>
											<li class="divider"> </li>
											
											<?php if($obj1->status !='Lulus' && $this->session->userdata('role')=='donatur'){?>
												<li>
													<a href="<?php echo base_url();?>index.php/<?php echo $this->session->userdata('role');?>/approved_b/<?php echo $obj1->id_b.'/donatur';?>">
														<i class="icon-check"></i> Approved </a>
												</li>
											<?php } ?>
											<?php if($obj1->status !='Tidak_Lulus' && $this->session->userdata('role')=='donatur'){ ?>
											<li>
												<a href="<?php echo base_url();?>index.php/<?php echo $this->session->userdata('role');?>/unapproved_b/<?php echo $obj1->id_b.'/donatur';?>">
