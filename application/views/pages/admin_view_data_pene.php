							...
							<tr class="odd gradeX">
								...
								<td>
									...
									elseif($obj1->status =='unapproved'){
										...
										echo "<span class='label label-sm label-default'> Panding </span>";
									}
								...
								<td>
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-left" role="menu">
											...
											<?php if($obj1->status !='approved'){?>
												<li>
													<a href="<?php echo base_url();?>index.php/admin/akun_simpan/<?php echo $obj1->id.'/penerima';?>">
														<i class="icon-check"></i> Approved </a>
												</li>
											<?php } ?>
											<?php if($obj1->status !='unapproved'){ ?>
											<li>
												<a href="<?php echo base_url();?>index.php/admin/unapproved/<?php echo $obj1->id.'/penerima';?>">
